...
sifqc = sif_qc("/mnt/g/TROPOMI/esa/gridded/no_reflectance/1deg/TROPOMI.ESA.SIF.2019.8day.1deg.veg_only_no_hot.nc", "SIF_Corr_743", "n", "SIF_Corr_743_std", 1, 46);
heatmap(sifqc[:,:,23], title = "SIF QCed", bg = :white, color = :viridis)
save_nc(sifqc, "/mnt/g/ChloFluo/input/SIF/1deg/SIFqc.8day.1deg.veg_only.CF80.2019.no.hot.nc", 2019, "sif743_qc", "SIF743 Quality Controlled", "mW/m²/sr/nm");
...
# Calculate APARchl
apar = calc_apar("/mnt/g/ChloFluo/input/SIF/1deg/SIFqc.8day.1deg.veg_only.CF80.2019.no.hot.nc", "/mnt/g/ChloFluo/input/yield/1deg/yield.2019.8-day.1deg.v2.nc");
heatmap(apar[:,:,23], title = "APAR Chlorophyll", bg = :white, color = :viridis)
save_nc(apar, "/mnt/g/ChloFluo/input/APARchl/1deg/apar.2019.8-day.1deg.v2.no.hot.nc", 2019, "aparchl", "Absorbed PAR by Chlorophyll", "μmol/m-2/day-1");
...
gpp = calc_gpp("/mnt/g/ChloFluo/input/APARchl/1deg/apar.2019.8-day.1deg.v2.no.hot.nc", "/mnt/g/ChloFluo/input/LUE/1deg/LUEmax.1deg.nc", "/mnt/g/ChloFluo/input/stress/1deg/stress.8-day.1deg.2019.nc");
heatmap(gpp[:,:,23], title = "Gross Primary Production", bg = :white, color = :viridis)
save_nc(gpp, "/mnt/g/ChloFluo/product/v02/ChloFluo.GPP.v02.1deg.CF80.2019.no.hot.nc", 2019, "gpp", "Gross Primary Production", "g C/m-2/day-1");
