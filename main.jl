...
topt, tmin, tmax = tparams("/mnt/g/ChloFluo/input/landcover/mcd12c1/original/MCD12C1.A2019001.061.2022170020638.hdf");
...
save_nc(tmin, "/mnt/g/ChloFluo/input/Temp/min/5km/tmin.5km.2019.nc", 2019, "tmin", "Minimum Temperature", "C");
save_nc(tmax, "/mnt/g/ChloFluo/input/Temp/max/5km/tmax.5km.2019.nc", 2019, "tmax", "Maximum Temperature", "C");
...
save_nc(gpp, "/mnt/g/ChloFluo/product/v02/ChloFluo.GPP.v02.1deg.CF80.2019.again.nc", 2019, "gpp", "Gross Primary Production", "g C/m-2/day-1");
